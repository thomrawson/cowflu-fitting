...
##################################################################################################
## Tidy up:
rm(state_summary, chain, ess, file_path, first_infection, i, I_data, infections, n_states, n_timepoints,
   place, regions_to_plot, state, data_list, data_outbreaks, my_plot, my_plot_prop, plot_indices, psrf,
