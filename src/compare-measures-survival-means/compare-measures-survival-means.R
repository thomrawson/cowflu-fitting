...
samples <- samples[, round(seq(from = 1, to = dim(samples)[2], length.out = total_samples)) ]
...
## Function to compute 95% CI of mean via bootstrapping
...
Factual_data1$lower_value[i] <- bootstrap_mean_ci(Realtime_infected1[,i])[1]
Factual_data1$upper_value[i] <- bootstrap_mean_ci(Realtime_infected1[,i])[2]

Factual_data2$metric[i] <- "Total_infected"
Factual_data2$Week[i] <- Weeks[i]
Factual_data2$mean_value[i] <- mean(Total_infected1[,i])
Factual_data2$lower_value[i] <- bootstrap_mean_ci(Total_infected1[,i])[1]
Factual_data2$upper_value[i] <- bootstrap_mean_ci(Total_infected1[,i])[2]
...
Factual_data3$lower_value[i] <- bootstrap_mean_ci(Confirmed_outbreaks1[,i])[1]
Factual_data3$upper_value[i] <- bootstrap_mean_ci(Confirmed_outbreaks1[,i])[2]
...
Factual_data4$lower_value[i] <- bootstrap_mean_ci(True_infected_herds1[,i])[1]
Factual_data4$upper_value[i] <- bootstrap_mean_ci(True_infected_herds1[,i])[2]
...
for(i in 1:length(Weeks)){
  ...
  Counterfactual_data1$lower_value[i] <- bootstrap_mean_ci(Realtime_infected2[,i])[1]
  Counterfactual_data1$upper_value[i] <- bootstrap_mean_ci(Realtime_infected2[,i])[2]
  ...
  Counterfactual_data2$lower_value[i] <- bootstrap_mean_ci(Total_infected2[,i])[1]
  Counterfactual_data2$upper_value[i] <- bootstrap_mean_ci(Total_infected2[,i])[2]
  ...
  Counterfactual_data3$lower_value[i] <- bootstrap_mean_ci(Confirmed_outbreaks2[,i])[1]
  Counterfactual_data3$upper_value[i] <- bootstrap_mean_ci(Confirmed_outbreaks2[,i])[2]
  ...
  Counterfactual_data4$lower_value[i] <- bootstrap_mean_ci(True_infected_herds2[,i])[1]
  Counterfactual_data4$upper_value[i] <- bootstrap_mean_ci(True_infected_herds2[,i])[2]
...
for(i in 1:length(Weeks)){
  ...
  Counterfactual_data1$lower_value[i] <- bootstrap_mean_ci(Realtime_infected3[,i])[1]
  Counterfactual_data1$upper_value[i] <- bootstrap_mean_ci(Realtime_infected3[,i])[2]

  Counterfactual_data2$metric[i] <- "Total_infected"
  Counterfactual_data2$Week[i] <- Weeks[i]
  Counterfactual_data2$mean_value[i] <- mean(Total_infected3[,i])
  Counterfactual_data2$lower_value[i] <- bootstrap_mean_ci(Total_infected3[,i])[1]
  Counterfactual_data2$upper_value[i] <- bootstrap_mean_ci(Total_infected3[,i])[2]

  Counterfactual_data3$metric[i] <- "Declared_outbreaks"
  Counterfactual_data3$Week[i] <- Weeks[i]
  Counterfactual_data3$mean_value[i] <- mean(Confirmed_outbreaks3[,i])
  Counterfactual_data3$lower_value[i] <- bootstrap_mean_ci(Confirmed_outbreaks3[,i])[1]
  Counterfactual_data3$upper_value[i] <- bootstrap_mean_ci(Confirmed_outbreaks3[,i])[2]

  Counterfactual_data4$metric[i] <- "True_infected_herds"
  Counterfactual_data4$Week[i] <- Weeks[i]
  Counterfactual_data4$mean_value[i] <- mean(True_infected_herds3[,i])
  Counterfactual_data4$lower_value[i] <- bootstrap_mean_ci(True_infected_herds3[,i])[1]
  Counterfactual_data4$upper_value[i] <- bootstrap_mean_ci(True_infected_herds3[,i])[2]
...
Counterfactual_differences <- data.frame( measures = c(#"No measures", "No measures",
                                          ...
                                          mean_value = c(#mean(No_measures_Realtime_infected),
                                                         mean(No_measures_Confirmed_outbreaks[,46]),
                                                         #mean(No_measures_True_infected_herds),
                                                         mean(No_measures_Total_infected[,46]),

                                                         #mean(Stronger_measures_Realtime_infected),
                                                         mean(Stronger_measures_Confirmed_outbreaks[,46]),
                                                         #mean(Stronger_measures_True_infected_herds),
                                                         mean(Stronger_measures_Total_infected[,46])),

                                          lower_value = c(#quantile(No_measures_Realtime_infected, 0.025),
                                            bootstrap_mean_ci(No_measures_Confirmed_outbreaks[,46])[1],
                                                          #quantile(No_measures_True_infected_herds, 0.025),
                                            bootstrap_mean_ci(No_measures_Total_infected[,46])[1],

                                                          #quantile(Stronger_measures_Realtime_infected, 0.025),
                                            bootstrap_mean_ci(Stronger_measures_Confirmed_outbreaks[,46])[1],
                                                          #quantile(Stronger_measures_True_infected_herds, 0.025),
                                            bootstrap_mean_ci(Stronger_measures_Total_infected[,46])[1]),

                                          upper_value = c(#quantile(No_measures_Realtime_infected, 0.975),
                                            bootstrap_mean_ci(No_measures_Confirmed_outbreaks[,46])[2],
                                                          #quantile(No_measures_True_infected_herds, 0.975),
                                            bootstrap_mean_ci(No_measures_Total_infected[,46])[2],

                                                          #quantile(Stronger_measures_Realtime_infected, 0.975),
                                            bootstrap_mean_ci(Stronger_measures_Confirmed_outbreaks[,46])[2],
                                                          #quantile(Stronger_measures_True_infected_herds, 0.975),
                                            bootstrap_mean_ci(Stronger_measures_Total_infected[,46])[2])
                                          )
